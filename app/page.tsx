      ...
      {formData.length !== 0 ? formData.map(item => (
        <div key={item.city} className="flex justify-between items-center mt-6 w-100 text-white bg-zinc-800 px-10 py-5 rounded-3xl">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-center cursor-pointer h-12 w-10 rounded hover:bg-red-500 group">
            ...
            <div className="flex items-center justify-center cursor-pointer h-12 w-10 rounded hover:bg-green-500 group">
